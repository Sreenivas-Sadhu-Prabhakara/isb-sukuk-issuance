package com.bank.islamic.sukukissuance.model;
...
/**
 * The BIAN control record for this service domain: "Sukuk Issuance Program Procedure".
 *
 ...
 * to its asset type (Sukuk Issuance Program). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Sukuk Issuance Program Procedure";
